...
INDEXNOW_KEY = "127898ad5d2ed878af4659f45774aba9"
...
NAV = [
    ...
    ("지역별 안내", "/ansan/", [
        ("안산시 전체", "/ansan/"),
        ("상록구", "/ansan/sangnok-gu-chuljangmassage/"),
        ("단원구", "/ansan/danwon-gu-chuljangmassage/"),
        ("본오동", "/ansan/sangnok/bono-dong-chuljangmassage/"),
        ("사동", "/ansan/sangnok/sa-dong-chuljangmassage/"),
        ("고잔동", "/ansan/danwon/gojan-dong-chuljangmassage/"),
        ("초지동", "/ansan/danwon/choji-dong-chuljangmassage/"),
        ("선부동", "/ansan/danwon/seonbu-dong-chuljangmassage/"),
    ]),
    ("지하철역별 안내", "/ansan/stations/", [
        ("역 전체", "/ansan/stations/"),
        ("중앙역", "/ansan/jungang-station-chuljangmassage/"),
        ("고잔역", "/ansan/gojan-station-chuljangmassage/"),
        ("초지역", "/ansan/choji-station-chuljangmassage/"),
        ("안산역", "/ansan/ansan-station-chuljangmassage/"),
        ("상록수역", "/ansan/sangnoksu-station-chuljangmassage/"),
        ("한대앞역", "/ansan/hanyang-univ-ansan-station-chuljangmassage/"),
        ("반월역", "/ansan/banwol-station-chuljangmassage/"),
        ("사리역", "/ansan/sari-station-chuljangmassage/"),
        ("신길온천역", "/ansan/singiloncheon-station-chuljangmassage/"),
        ("선부역", "/ansan/seonbu-station-chuljangmassage/"),
        ("달미역", "/ansan/dalmi-station-chuljangmassage/"),
        ("시우역", "/ansan/siu-station-chuljangmassage/"),
        ("원시역", "/ansan/wonsi-station-chuljangmassage/"),
    ]),
    ("테마별 안내", "/themes/", [
        ("전체 테마", "/themes/"),
        ("스웨디시", "/themes/swedish/"),
